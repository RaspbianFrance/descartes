<?php
	...
	class Controller
    {
         ...
         * @param boolean $nl2br : If true, replace "\n" by "<br/>", false by default
         * @param boolean $escape_quotes : If true, turn quotes and double quotes into html entities, true by default
         * @param boolean $echo : If true, print text, else return it without printing
		 *
         * @return string : modified text
		 */
		public static function s (string $text, boolean $nl2br = false, boolean $escape_quotes = true, boolean $echo = true) string
		{
